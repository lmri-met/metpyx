...
class TestValidInputs:
    def test_is_series_valid_series(self):
        q = Qualities()
    ...
    def test_is_quality_valid_qualities(self):
        q = Qualities()
    ...
    def test_get_qualities_valid_series(self):
        q = Qualities()
    ...
    def test_get_series_valid_qualities(self):
        q = Qualities()
    ...
    def test_get_inherent_filtration_valid_quality(self):
        q = Qualities()
    ...
    def test_get_additional_filtration_valid_quality(self):
        q = Qualities()
    ...
    def test_get_total_filtration_valid_quality(self):
        q = Qualities()
